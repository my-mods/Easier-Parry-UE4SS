...
Release guard before attacking. Attack-from-guard support is not part of this build. Dodge uses the original native attack-interruption and eligibility path; no mod timer or forced animation cancellation is added.
